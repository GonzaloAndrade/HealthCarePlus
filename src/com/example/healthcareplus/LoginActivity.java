	...
	public void onCreate(Bundle savedInstanceState) {
		...
		btnIniciarSesion.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View view) {
				...
				Intent i = new Intent(getApplicationContext(), secretaria.AddPatient.class);
				startActivity(i);
			...
			runOnUiThread(new Runnable() {
				public void run() {
					...
					try {
						...
						params.add(new BasicNameValuePair("usu_usuario", ""));
						//params.add(new BasicNameValuePair("usu_contrasena", (String) txtContrasena.getText().toString()));
						params.add(new BasicNameValuePair("usu_contrasena", ""));
